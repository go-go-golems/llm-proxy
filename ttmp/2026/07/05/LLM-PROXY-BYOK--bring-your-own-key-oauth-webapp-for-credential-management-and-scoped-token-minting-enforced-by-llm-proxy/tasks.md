...
- [x] Phase 3: control-plane webapp — OIDC login (Keycloak compose), credential CRUD, token mint/revoke UI, usage dashboard
...
- [x] Resolve open questions: single binary vs two services; token counting for streaming; profile-slug vs provider/model scopes; control-plane repo location
