...
- [x] Schema: add a `schema_version` table/pragma to `pkg/byok/store/sqlite/store.go` + a forward-only migration runner; document the migration contract; test against both backends
